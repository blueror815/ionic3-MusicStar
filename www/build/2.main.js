...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__menu__ = __webpack_require__(289);
...
MenuPage = __decorate([
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["_6" /* Component */])({
        selector: 'page-menu',template:/*ion-inline-start:"/Users/apple/Documents/Project/Ionic/Template/Star-Ionic-3/src/pages/menu/menu.html"*/'<ion-split-pane>\n\n  <ion-menu [content]="content">\n    <ion-header>\n      <ion-toolbar>\n        <ion-title>Favorites</ion-title>\n      </ion-toolbar>\n    </ion-header>\n    <ion-content>\n      <ion-list>\n        <a ion-item *ngFor="let favorite of favorites" (click)="goToDetail(favorite)">\n          <ion-label>\n            <h2>{{favorite.name}}</h2>\n            <h3>by {{favorite.artists[0].name}}</h3>\n          </ion-label>\n        </a>\n      </ion-list>\n    </ion-content>\n  </ion-menu>\n\n  <ion-nav [root]="menuRoot" #content persistent="false" main></ion-nav>\n\n</ion-split-pane>\n'/*ion-inline-end:"/Users/apple/Documents/Project/Ionic/Template/Star-Ionic-3/src/pages/menu/menu.html"*/,
    }),
